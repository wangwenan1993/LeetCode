 ...
 */
public class _4_FindMedianOfSortedArrays {
	public double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        System.out.println("[" + nums1[0] + "," + nums1[m - 1] + "] " + m);
        System.out.println("[" + nums2[0] + "," + nums2[n - 1] + "] " + n);
	...
	public static void main(String[] args) {
		int[] nums1 = {1,3};
		int[] nums2 = {2};
		_4_FindMedianOfSortedArrays fclass = new _4_FindMedianOfSortedArrays();
		System.out.println(fclass.findMedianSortedArrays(nums1, nums2));
	}
